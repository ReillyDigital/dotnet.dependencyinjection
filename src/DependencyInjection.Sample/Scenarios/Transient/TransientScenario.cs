...
public static class TransientScenario
{
	public static void Run()
	{
		...
		// Get a new instance of a class that has a parameterless class constructor and also dependency properties marked
		// with a InjectAttribute:
		var myClass = (AppContext.GetData("ServiceProvider") as IServiceProvider)!.Transient<MyClass>()!;
	...
	public class MyClass
	{
		...
		// Make use of the dependency that was injected:
